...
import {
  ...
  updateViewOnZoom,
  warnDeprecated
} from "./chunk-IG4NAVEB.js";
import "./chunk-5RWUM4OC.js";
import {
  ...
  function(_super) {
    ...
    LineView2.prototype._endLabelOnDuring = function(percent, clipRect, data, animationRecord, valueAnimation, endLabelModel, coordSys) {
      ...
      if (endLabel) {
        ...
        if (valueAnimation) {
          var inner3 = labelInner(endLabel);
          if (typeof inner3.setLabelText === "function") {
            inner3.setLabelText(value);
          }
        }
      }
    };
...
function mapVisual(nodeModel, visuals, child, index, mapping, seriesModel) {
  ...
  if (mapping) {
    ...
    var colorMappingBy = mappingType === "color" && inner2(mapping).drColorMappingBy;
